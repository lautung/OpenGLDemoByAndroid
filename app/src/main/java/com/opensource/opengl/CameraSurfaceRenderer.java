...
import com.opensource.opengl.utils.ResReadUtils;
import com.opensource.opengl.utils.ShaderUtils;
...
//设置背景颜色
        ...
        //编译
        final int vertexShaderId = ShaderUtils.compileVertexShader(ResReadUtils.readResource(R.raw.vertex_camera_shader,AppCore.getInstance().getContext()));
        final int fragmentShaderId = ShaderUtils.compileFragmentShader(ResReadUtils.readResource(R.raw.fragment_camera_shader,AppCore.getInstance().getContext()));
        //链接程序片段
