...
public class VaryTools {
    ...
    public void setMatrixCamera(float[] matrixCamera) {
        mMatrixCamera = matrixCamera;
    }

    public void setMatrixProjection(float[] matrixProjection) {
        mMatrixProjection = matrixProjection;
    }
